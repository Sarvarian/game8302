...
class Main:
    ...
    def setup(self):
        ...
        """
        fs = self.fs
        self.main_template = read_content(fs.main_template_file)
    ...
    def run(self):
        ...
        result = self.main_template.replace("//_GENERATE_TYPE_HERE", result)
        ...
        result += "\n"
        write_content(self.fs.output_file, result)
        # generate predefine
        # generate structures
